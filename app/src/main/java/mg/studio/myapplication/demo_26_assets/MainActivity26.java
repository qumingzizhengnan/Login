package mg.studio.myapplication.demo_26_assets;
...
public class MainActivity26 extends AppCompatActivity {
    ...
    private static final String TAG_LOG = MainActivity26.class.getSimpleName();
    private static final int MY_PERMISSIONS_REQUEST_WRITE_LOCAL_STORAGE = 121;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.assets_folder);
